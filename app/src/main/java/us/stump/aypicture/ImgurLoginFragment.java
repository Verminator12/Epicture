...
import us.stump.aypicture.api.model.ImgurAccessToken;
...
public class ImgurLoginFragment extends Fragment {
     ...
     * Our Imgur API Application's app redirect URL
     */
    private String getImgurAppRedirect() {
     ...
     */
    private void clearHistoryAndCookies()
    {
     ...
     */
    private void onImgurTokenReceived(ImgurAccessToken accessToken) {
    ...
    private class LoginWebViewClient extends WebViewClient
    {
         ...
         */
        private final ImgurLoginFragment loginFragment;
        ...
        private void handleAppRedirect(WebView view, Uri url)
        {
            if (loginFragment != null) {
                ...
                if (!accessToken.equals(handledAccessToken)) {
